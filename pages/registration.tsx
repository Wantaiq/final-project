      ...
      <main className="flex justify-center">
        <form onSubmit={handleSubmit(handleUserRegistration)}>
          ...
          <div className="flex flex-col justify-center items-center mx-auto mt-12 space-y-6">
            ...
            <button
              className="bg-cyan-400 py-[0.5em] rounded-full font-bold tracking-wider self-center px-[1.4em] scale-100 duration-200 text-gray-800 ease-in hover:scale-110 hover:bg-cyan-800 hover:text-slate-100 focus:scale-105 focus:bg-cyan-800 cursor-pointer"
